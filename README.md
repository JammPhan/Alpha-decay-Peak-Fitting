...
Improvements need to be made to fit. Particularly in the first and last peaks. Suspect you need to make improvements to the initial guess parameters for the fit and reduce the number of free variables in the fitting algorithm.
